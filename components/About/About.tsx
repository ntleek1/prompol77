...
<p style="text-align: justify;">Наша компания более 20 лет занимается профессиональным производством промышленных полов различных видов и направленности. Если у Вас существует техническое задание &ndash; мы выполним его строго по прописанным в нём пунктам. Если его нет &ndash; поможем составить, подобрать лучшие для его выполнения материалы.</p>
          </Typography>
        </Box>
