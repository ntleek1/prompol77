...
export const Meta = {
  ...
  [Routes.Service]: {
    ...
    description:
      "Наша компания более 20 лет занимается профессиональным производством промышленных полов различных видов и направленности. Если у Вас существует техническое задание – мы выполним его строго по прописанным в нём пунктам. Если его нет – поможем составить, подобрать лучшие для его выполнения материалы.",
  },
  [Routes.Portfolio]: {
